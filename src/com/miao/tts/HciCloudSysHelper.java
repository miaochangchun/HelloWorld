...
public class HciCloudSysHelper {
	...
	static {
		...
		// 指定dll文件路径，顺序表示加载顺序
		String sysLibPath[] = new String[] { libPath + File.separator + "libhci_curl.dll",
				libPath + File.separator + "hci_sys.dll",
				libPath + File.separator +"hci_sys_jni.dll" };
		// 加载hci_sys.dll
	...
	private InitParam getInitParam() {
		String authDirPath = sPath + File.separator + "UserInfo";
		String logPath = sPath + File.separator + "Log";
